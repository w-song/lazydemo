...
public class TestAuditService extends CrudService<TestAuditDao, TestAudit> {
    ...
    public void save(TestAudit testAudit) {
        ...
        // 重新编辑申请
            ...
            actTaskService.complete(testAudit.getAct().getTaskId(), testAudit.getAct().getProcInsId(), testAudit
                    .getAct().getComment(), testAudit.getContent(), vars);
        }
    }
    ...
    public void auditSave(TestAudit testAudit) {
        ...
        Map<String, Object> vars = Maps.newHashMap();
        vars.put("pass", "yes".equals(testAudit.getAct().getFlag()) ? "1" : "0");
        actTaskService.complete(testAudit.getAct().getTaskId(), testAudit.getAct().getProcInsId(), testAudit.getAct()
                .getComment(), vars);
