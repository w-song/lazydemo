...
public class MobileSendMessage {
    ...
    //
    // ChannelKeyPair pair = new ChannelKeyPair(MobileSendMessage.apiKey,
    // MobileSendMessage.secretKey);
    //
    ...
    // * @param users
    // */
    // public static void pushUnicastMessageMessage(String title,String
    // content,List<String> userIds) {
    //
    // ChannelKeyPair pair = new ChannelKeyPair(MobileSendMessage.apiKey,
    // MobileSendMessage.secretKey);
    //
