...
<body>
	<div class="container-fluid">
		...
		<div class="errorMessage">
			...
			<a href="javascript:" onclick="$('.errorMessage').toggle();" class="btn btn-default">查看详细信息</a>
		</div>
		<div class="errorMessage hide-element">
			<%=StringUtils.toHtml(sb.toString())%> <br/>
			<a href="javascript:" onclick="history.go(-1);" class="btn btn-default">返回上一页</a> &nbsp;
			<a href="javascript:" onclick="$('.errorMessage').toggle();" class="btn btn-default">隐藏详细信息</a>
			<br/> <br/>
		</div>
		<script>try{closeDialog();}catch(e){}</script>
	</div>
</body>
</html>
<%
