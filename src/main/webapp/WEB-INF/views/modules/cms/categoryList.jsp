            ...
            <table id="treeTable" class="table table-striped table-bordered">
                ...
                <c:forEach items="${list}" var="tpl">
                    <tr id="${tpl.id}" pId="${tpl.parent.id ne '1'?tpl.parent.id:'0'}">
                        ...
                        <td style="text-align: center;"><shiro:hasPermission name="cms:category:edit">
                                <input type="hidden" name="ids" value="${tpl.id}" />
                                <input class="form-control input-sm sort-input" name="sorts" type="text" value="${tpl.sort}">
                            </shiro:hasPermission>
                        ...
                        <td><a href="${pageContext.request.contextPath}${fns:getFrontPath()}/list-${tpl.id}${fns:getUrlSuffix()}" target="_blank">访问</a> <shiro:hasPermission
