...
<link href="${ctxStatic}/jquery-validation/1.11.1/jquery.validate.min.css" rel="stylesheet" />
...
<style>.reply{border:1px solid #ddd;background:#fefefe;margin:10px;}</style>
<script>
	$(function() {
		comment(0);
	});
	...
	<form:form action="${ctx}/comment" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				...
				<input class="btn mid" type="submit" value="提交"/>&nbsp;
			</div>
		</div>
		<div class="alert alert-danger messageBox" style="display:none">输入有误，请先更正。</div>
	</form:form><!--*/-->
</script>