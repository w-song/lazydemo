...
<body>
    ...
    <div class="container-fluid">
        <form:form id="searchForm" modelAttribute="genTable" action="${ctx}/gen/genTable/" method="post" class="breadcrumb form-inline form-search">
            ...
            <div class="row">
                <div class="form-group">
                    <label>表名：</label>
                    <form:input path="nameLike" htmlEscape="false" maxlength="50" cssClass="form-control"/>
                </div>
                <div class="form-group">
                    <label>说明：</label>
                    <form:input path="comments" htmlEscape="false" maxlength="50" cssClass="form-control"/>
                </div>
                <div class="form-group">
                    <label>父表表名：</label>
                    <form:input path="parentTable" htmlEscape="false" maxlength="50" cssClass="form-control"/>
                </div>
                <div class="form-group">
