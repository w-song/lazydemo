...
<body>
    ...
    <div class="container-fluid">
        ...
        <div id="messageBoxError" class="alert alert-danger">
            ...
            <tbody>
                <c:forEach items="${page.list}" var="genTemplate">
                    <tr>
                        ...
                        <shiro:hasPermission name="gen:genTemplate:edit">
                            <td><a href="${ctx}/gen/genTemplate/form?id=${genTemplate.id}">修改</a> <a href="${ctx}/gen/genTemplate/delete?id=${genTemplate.id}"
