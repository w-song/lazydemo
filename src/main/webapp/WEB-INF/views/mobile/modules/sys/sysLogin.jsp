        ...
        <article data-scroll="true" id="login_article">
	        <div class="indented">
	            <form id="loginForm" action="${ctx}/login" method="post">
	                ...
	                <button id="btn btn-default" class="submit block" data-icon="key">登录</button>
	            </form>
	        </div>
	    </article>
    </section>
</div>
<!--<script src="${ctxStatic}/jingle/js/lib/cordova.js"></script>-->
<!-- lib -->
<script src="${ctxStatic}/jingle/js/lib/zepto.js"></script>
<script src="${ctxStatic}/jingle/js/lib/iscroll.js"></script>
<%-- <script src="${ctxStatic}/jingle/js/lib/template.min.js"></script> --%>
<script src="${ctxStatic}/jingle/js/lib/Jingle.debug.js"></script>
<script src="${ctxStatic}/jingle/js/lib/zepto.touch2mouse.js"></script>
<%-- <script src="${ctxStatic}/jingle/js/lib/JChart.debug.js"></script> --%>
<!--- app --->
<script>var ctx = '${ctx}';</script>
<script src="${ctxStatic}/jingle/js/app/app.js"></script>
