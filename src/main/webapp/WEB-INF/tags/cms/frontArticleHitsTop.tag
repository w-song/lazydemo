...
<div class="panel panel-theme-1 ${cssClass}">
    <div class="panel-heading">
        <span class="category-title"><i class="fa fa-thumbs-up icon"></i> 栏目推荐</span>
    </div>
    <div class="panel-body">
        <div class="list-theme-1">
            <ul class="list-ul">
                <c:forEach items="${fnc:getArticleList(category.site.id, category.id, not empty pageSize ? pageSize : 5, 'posid : 2, orderBy : \"hits desc\"')}" var="article" varStatus="status">
                    <li>
